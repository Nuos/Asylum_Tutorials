...
uint16_t qGLExtensions::GLSLVersion = 0;
uint16_t qGLExtensions::GLVersion = 0;
int32_t qGLExtensions::MaxUniformBlockSize = 0;
int32_t qGLExtensions::UniformBufferOffsetAlignment = 0;

std::string qGLExtensions::GLVendor;
std::string qGLExtensions::GLRenderer;
std::string qGLExtensions::GLAPIVersion;
...
bool qGLExtensions::ARB_texture_multisample = false;
...
bool qGLExtensions::ARB_multi_draw_indirect = false;
bool qGLExtensions::ARB_indirect_parameters = false;
...
qGLExtensions::qGLExtensions ()
{
}

void qGLExtensions::QueryFeatures (void* hdc)
{
	if (GLVersion > 0)
		return;
